...
import { CloseIcon } from '../icons/IconComponents.tsx';
import UnifiedProgressBar from '../UnifiedProgressBar.tsx';
import { calculateProgress } from '../../utils/calculateProgress.ts';
import { calculatePlannedProgress, getPerformanceStatus } from '../../utils/calculatePlannedProgress.ts';
import { locales } from '../../i18n/locales.ts';
import { useDepartmentsData } from '../../context/DepartmentsDataContext.tsx';
import { departments } from '../../data/mockData.ts';
import PriorityBadge from '../PriorityBadge.tsx';
import { translateChallengeField, translateDepartment } from '../../utils/localizationUtils.ts';
                ...
                <div className="p-6 overflow-y-auto space-y-6">
                    ...
                    <DetailSection title={t('challenges.detailsModal.summary')}>
                         <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <DetailItem label={t('challenges.actualProgress')} value={`${actualProgress}%`} />
                            <DetailItem label={t('challenges.plannedProgress')} value={`${plannedProgress}%`} />
                        </div>
                    </DetailSection>
