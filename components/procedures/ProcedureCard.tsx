...
const ProcedureCard: React.FC<ProcedureCardProps> = ({ procedure, onViewDetails, onEdit, onDelete }) => {
    ...
    return (
        <Card 
            className="group relative flex flex-col h-full transition-all duration-300 hover:shadow-xl hover:-translate-y-1 hover:border-dark-purple-400 dark:hover:border-dark-purple-500"
